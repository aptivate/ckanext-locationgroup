...
class LocationGroupController(group.GroupController):
    ...
    def _action(self, action_name):
        ...
        if action_name == 'group_create':
            action_name = 'location_create'
        elif action_name == 'group_list':
            action_name = 'location_list'

        return super(LocationGroupController, self)._action(action_name)
    ...
    def members(self, id):
        ...
        return self._render_template('locationgroup/members.html', group_type)
